...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20221130210056-b7e4e9d0ce62 // indirect
	...
	github.com/theupdateframework/go-tuf v0.5.2-0.20221202173518-c803c816c706 // indirect
