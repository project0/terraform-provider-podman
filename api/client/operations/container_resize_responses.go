...
type ContainerResizeNotFound struct {
	Payload *models.ContainerResizeNotFoundBody
}
...
func (o *ContainerResizeNotFound) GetPayload() *models.ContainerResizeNotFoundBody {
	return o.Payload
}
...
func (o *ContainerResizeNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ContainerResizeNotFoundBody)
...
type ContainerResizeInternalServerError struct {
	Payload *models.ContainerResizeInternalServerErrorBody
}
...
func (o *ContainerResizeInternalServerError) GetPayload() *models.ContainerResizeInternalServerErrorBody {
	return o.Payload
}
...
func (o *ContainerResizeInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ContainerResizeInternalServerErrorBody)
