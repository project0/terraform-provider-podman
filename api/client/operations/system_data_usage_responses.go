...
func (o *SystemDataUsageOK) GetPayload() *models.SystemDataUsageOKBody {
	return o.Payload
}
...
type SystemDataUsageInternalServerError struct {
	Payload *models.SystemDataUsageInternalServerErrorBody
}
...
func (o *SystemDataUsageInternalServerError) GetPayload() *models.SystemDataUsageInternalServerErrorBody {
	return o.Payload
}
...
func (o *SystemDataUsageInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.SystemDataUsageInternalServerErrorBody)
