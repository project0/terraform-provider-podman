...
type VolumeListInternalServerError struct {
	Payload *models.VolumeListInternalServerErrorBody
}
...
func (o *VolumeListInternalServerError) GetPayload() *models.VolumeListInternalServerErrorBody {
	return o.Payload
}
...
func (o *VolumeListInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.VolumeListInternalServerErrorBody)
