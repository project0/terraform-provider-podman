...
type VolumeCreateLibpodCreated struct {
	Payload *models.VolumeCreateLibpodCreatedBody
}
...
func (o *VolumeCreateLibpodCreated) GetPayload() *models.VolumeCreateLibpodCreatedBody {
	return o.Payload
}
...
func (o *VolumeCreateLibpodCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.VolumeCreateLibpodCreatedBody)
...
type VolumeCreateLibpodInternalServerError struct {
	Payload *models.VolumeCreateLibpodInternalServerErrorBody
}
...
func (o *VolumeCreateLibpodInternalServerError) GetPayload() *models.VolumeCreateLibpodInternalServerErrorBody {
	return o.Payload
}
...
func (o *VolumeCreateLibpodInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.VolumeCreateLibpodInternalServerErrorBody)
