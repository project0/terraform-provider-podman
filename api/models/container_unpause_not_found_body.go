...
func (m *ContainerUnpauseNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container unpause not found body based on context it is used
func (m *ContainerUnpauseNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerUnpauseNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerUnpauseNotFoundBody) UnmarshalBinary(b []byte) error {
