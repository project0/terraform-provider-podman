...
func (m *ImageLoadLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image load libpod bad request body based on context it is used
func (m *ImageLoadLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageLoadLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageLoadLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
