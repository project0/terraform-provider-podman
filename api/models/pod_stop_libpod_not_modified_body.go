...
func (m *PodStopLibpodNotModifiedBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this pod stop libpod not modified body based on context it is used
func (m *PodStopLibpodNotModifiedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PodStopLibpodNotModifiedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodStopLibpodNotModifiedBody) UnmarshalBinary(b []byte) error {
