...
func (m *ContainerTopLibpodOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerTopLibpodOKBody) validateProcesses(formats strfmt.Registry) error {
...
func (m *ContainerTopLibpodOKBody) validateTitles(formats strfmt.Registry) error {
...
func (m *ContainerTopLibpodOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerTopLibpodOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerTopLibpodOKBody) UnmarshalBinary(b []byte) error {
