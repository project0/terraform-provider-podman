...
func (m *NetworkDisconnectLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this network disconnect libpod internal server error body based on context it is used
func (m *NetworkDisconnectLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NetworkDisconnectLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NetworkDisconnectLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
