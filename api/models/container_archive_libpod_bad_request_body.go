...
func (m *ContainerArchiveLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container archive libpod bad request body based on context it is used
func (m *ContainerArchiveLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerArchiveLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerArchiveLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
