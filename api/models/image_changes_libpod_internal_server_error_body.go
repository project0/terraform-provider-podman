...
func (m *ImageChangesLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image changes libpod internal server error body based on context it is used
func (m *ImageChangesLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageChangesLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageChangesLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
