...
func (m *ContainerStatsLibpodConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container stats libpod conflict body based on context it is used
func (m *ContainerStatsLibpodConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerStatsLibpodConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerStatsLibpodConflictBody) UnmarshalBinary(b []byte) error {
