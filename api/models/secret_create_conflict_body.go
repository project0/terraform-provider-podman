...
func (m *SecretCreateConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this secret create conflict body based on context it is used
func (m *SecretCreateConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SecretCreateConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SecretCreateConflictBody) UnmarshalBinary(b []byte) error {
