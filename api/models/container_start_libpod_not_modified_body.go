...
func (m *ContainerStartLibpodNotModifiedBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container start libpod not modified body based on context it is used
func (m *ContainerStartLibpodNotModifiedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerStartLibpodNotModifiedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerStartLibpodNotModifiedBody) UnmarshalBinary(b []byte) error {
