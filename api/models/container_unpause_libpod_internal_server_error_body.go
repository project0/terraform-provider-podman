...
func (m *ContainerUnpauseLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container unpause libpod internal server error body based on context it is used
func (m *ContainerUnpauseLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerUnpauseLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerUnpauseLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
