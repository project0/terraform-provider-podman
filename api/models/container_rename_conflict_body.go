...
func (m *ContainerRenameConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container rename conflict body based on context it is used
func (m *ContainerRenameConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerRenameConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerRenameConflictBody) UnmarshalBinary(b []byte) error {
