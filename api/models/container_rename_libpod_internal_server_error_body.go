...
func (m *ContainerRenameLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container rename libpod internal server error body based on context it is used
func (m *ContainerRenameLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerRenameLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerRenameLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
