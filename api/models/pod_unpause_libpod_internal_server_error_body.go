...
func (m *PodUnpauseLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this pod unpause libpod internal server error body based on context it is used
func (m *PodUnpauseLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PodUnpauseLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodUnpauseLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
