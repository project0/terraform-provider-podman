...
func (m *PodTopLibpodOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PodTopLibpodOKBody) validateProcesses(formats strfmt.Registry) error {
...
func (m *PodTopLibpodOKBody) validateTitles(formats strfmt.Registry) error {
...
func (m *PodTopLibpodOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PodTopLibpodOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodTopLibpodOKBody) UnmarshalBinary(b []byte) error {
