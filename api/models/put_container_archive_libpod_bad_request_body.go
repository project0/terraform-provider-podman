...
func (m *PutContainerArchiveLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this put container archive libpod bad request body based on context it is used
func (m *PutContainerArchiveLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PutContainerArchiveLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PutContainerArchiveLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
