...
func (m *VolumeInspectLibpodOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VolumeInspectLibpodOKBody) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *VolumeInspectLibpodOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *VolumeInspectLibpodOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VolumeInspectLibpodOKBody) UnmarshalBinary(b []byte) error {
