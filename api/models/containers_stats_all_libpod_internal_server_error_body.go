...
func (m *ContainersStatsAllLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this containers stats all libpod internal server error body based on context it is used
func (m *ContainersStatsAllLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainersStatsAllLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainersStatsAllLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
