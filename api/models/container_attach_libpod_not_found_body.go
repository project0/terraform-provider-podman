...
func (m *ContainerAttachLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container attach libpod not found body based on context it is used
func (m *ContainerAttachLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerAttachLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerAttachLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
