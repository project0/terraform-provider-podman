...
func (m *ImageBuildBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image build bad request body based on context it is used
func (m *ImageBuildBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageBuildBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageBuildBadRequestBody) UnmarshalBinary(b []byte) error {
