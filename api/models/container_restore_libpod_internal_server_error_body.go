...
func (m *ContainerRestoreLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container restore libpod internal server error body based on context it is used
func (m *ContainerRestoreLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerRestoreLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerRestoreLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
