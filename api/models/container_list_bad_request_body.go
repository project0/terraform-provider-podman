...
func (m *ContainerListBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container list bad request body based on context it is used
func (m *ContainerListBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerListBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerListBadRequestBody) UnmarshalBinary(b []byte) error {
