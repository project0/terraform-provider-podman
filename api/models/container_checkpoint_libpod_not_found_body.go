...
func (m *ContainerCheckpointLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container checkpoint libpod not found body based on context it is used
func (m *ContainerCheckpointLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerCheckpointLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerCheckpointLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
