...
func (m *ImageHistoryLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image history libpod internal server error body based on context it is used
func (m *ImageHistoryLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageHistoryLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageHistoryLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
