...
func (m *ImagePushNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image push not found body based on context it is used
func (m *ImagePushNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImagePushNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImagePushNotFoundBody) UnmarshalBinary(b []byte) error {
