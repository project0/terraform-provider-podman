...
func (m *SystemDataUsageLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this system data usage libpod internal server error body based on context it is used
func (m *SystemDataUsageLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SystemDataUsageLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemDataUsageLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
