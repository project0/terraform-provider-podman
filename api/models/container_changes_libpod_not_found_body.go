...
func (m *ContainerChangesLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container changes libpod not found body based on context it is used
func (m *ContainerChangesLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerChangesLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerChangesLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
