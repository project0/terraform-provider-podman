...
func (m *ContainerUnmountLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container unmount libpod internal server error body based on context it is used
func (m *ContainerUnmountLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerUnmountLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerUnmountLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
