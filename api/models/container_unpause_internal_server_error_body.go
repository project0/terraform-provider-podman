...
func (m *ContainerUnpauseInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container unpause internal server error body based on context it is used
func (m *ContainerUnpauseInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerUnpauseInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerUnpauseInternalServerErrorBody) UnmarshalBinary(b []byte) error {
