...
func (m *ImageTagBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image tag bad request body based on context it is used
func (m *ImageTagBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageTagBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageTagBadRequestBody) UnmarshalBinary(b []byte) error {
