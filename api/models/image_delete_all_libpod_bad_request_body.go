...
func (m *ImageDeleteAllLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image delete all libpod bad request body based on context it is used
func (m *ImageDeleteAllLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageDeleteAllLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageDeleteAllLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
