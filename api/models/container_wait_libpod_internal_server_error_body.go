...
func (m *ContainerWaitLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container wait libpod internal server error body based on context it is used
func (m *ContainerWaitLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerWaitLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerWaitLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
