...
func (m *ContainerArchiveLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container archive libpod internal server error body based on context it is used
func (m *ContainerArchiveLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerArchiveLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerArchiveLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
