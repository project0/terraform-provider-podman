...
func (m *ContainerDeleteLibpodConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container delete libpod conflict body based on context it is used
func (m *ContainerDeleteLibpodConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerDeleteLibpodConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerDeleteLibpodConflictBody) UnmarshalBinary(b []byte) error {
