...
func (m *PlayKubeLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this play kube libpod internal server error body based on context it is used
func (m *PlayKubeLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PlayKubeLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PlayKubeLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
