...
func (m *NetworkDisconnectLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this network disconnect libpod not found body based on context it is used
func (m *NetworkDisconnectLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NetworkDisconnectLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NetworkDisconnectLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
