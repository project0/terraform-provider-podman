...
func (m *ImageUntagLibpodConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image untag libpod conflict body based on context it is used
func (m *ImageUntagLibpodConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageUntagLibpodConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageUntagLibpodConflictBody) UnmarshalBinary(b []byte) error {
