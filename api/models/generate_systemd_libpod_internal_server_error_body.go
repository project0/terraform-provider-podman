...
func (m *GenerateSystemdLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this generate systemd libpod internal server error body based on context it is used
func (m *GenerateSystemdLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GenerateSystemdLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GenerateSystemdLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
