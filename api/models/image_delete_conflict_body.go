...
func (m *ImageDeleteConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image delete conflict body based on context it is used
func (m *ImageDeleteConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageDeleteConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageDeleteConflictBody) UnmarshalBinary(b []byte) error {
