...
func (m *ContainerResizeLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container resize libpod not found body based on context it is used
func (m *ContainerResizeLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerResizeLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerResizeLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
