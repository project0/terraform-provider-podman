...
func (m *SystemDataUsageInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this system data usage internal server error body based on context it is used
func (m *SystemDataUsageInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SystemDataUsageInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemDataUsageInternalServerErrorBody) UnmarshalBinary(b []byte) error {
