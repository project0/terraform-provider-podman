...
func (m *PutContainerArchiveInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this put container archive internal server error body based on context it is used
func (m *PutContainerArchiveInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PutContainerArchiveInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PutContainerArchiveInternalServerErrorBody) UnmarshalBinary(b []byte) error {
