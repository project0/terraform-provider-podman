...
func (m *ImageTreeLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this image tree libpod not found body based on context it is used
func (m *ImageTreeLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ImageTreeLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ImageTreeLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
