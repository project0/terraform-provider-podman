...
func (m *PodUnpauseLibpodNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this pod unpause libpod not found body based on context it is used
func (m *PodUnpauseLibpodNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PodUnpauseLibpodNotFoundBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodUnpauseLibpodNotFoundBody) UnmarshalBinary(b []byte) error {
