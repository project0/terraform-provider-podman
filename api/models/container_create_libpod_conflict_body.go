...
func (m *ContainerCreateLibpodConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container create libpod conflict body based on context it is used
func (m *ContainerCreateLibpodConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerCreateLibpodConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerCreateLibpodConflictBody) UnmarshalBinary(b []byte) error {
