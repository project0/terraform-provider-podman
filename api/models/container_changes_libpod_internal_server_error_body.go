...
func (m *ContainerChangesLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container changes libpod internal server error body based on context it is used
func (m *ContainerChangesLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerChangesLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerChangesLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
