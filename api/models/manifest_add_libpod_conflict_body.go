...
func (m *ManifestAddLibpodConflictBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this manifest add libpod conflict body based on context it is used
func (m *ManifestAddLibpodConflictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ManifestAddLibpodConflictBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ManifestAddLibpodConflictBody) UnmarshalBinary(b []byte) error {
