...
func (m *ContainerHealthcheckLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this container healthcheck libpod internal server error body based on context it is used
func (m *ContainerHealthcheckLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ContainerHealthcheckLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContainerHealthcheckLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
