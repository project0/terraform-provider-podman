...
func (m *ManifestModifyLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this manifest modify libpod bad request body based on context it is used
func (m *ManifestModifyLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ManifestModifyLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ManifestModifyLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
