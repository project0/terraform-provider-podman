...
func (m *ManifestModifyLibpodInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this manifest modify libpod internal server error body based on context it is used
func (m *ManifestModifyLibpodInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ManifestModifyLibpodInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ManifestModifyLibpodInternalServerErrorBody) UnmarshalBinary(b []byte) error {
