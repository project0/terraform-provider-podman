...
func (m *SystemPruneLibpodBadRequestBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this system prune libpod bad request body based on context it is used
func (m *SystemPruneLibpodBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SystemPruneLibpodBadRequestBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemPruneLibpodBadRequestBody) UnmarshalBinary(b []byte) error {
